...
"13": {"name": "Mark", "profile": "",
"text": "'Aside from this shop, it seems he's also running some franchise shops dealing in the silver and iron trade.'"},
...
"text": "With that, I turn and return to the back."},
