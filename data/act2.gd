...
"text": "'Hi Mark, do you mind if take my lunch break in here with you?'"},
...
"text": "(Lily is different. She's always coming back here during her breaks, trying to make idle conversation.)"},
...
"text": "'You're a writer? That's so cool!'"},
...
"text": "(I can only stare in silence. She legitimately might like Fortress Terra even more than I do.)"},
"31": {"name": "Lily", "profile": "lily",
...
"text": "'Oh... well, that's okay too. I know creatives like you always want to make sure we see only the best, complete work.'"},
...
"9": {"name": "Lily", "profile": "lily",
"text": "'It felt like such perfect timing that it was almost suspicious.'"},
"10": {"name": "Mark", "profile": "lily",
"text": "'The Old Man certainly is a mysterious character. Like how he's called 'Old Man' without looking very old.'"},
...
"text": "(I flip through my stack of old journal books and choose one.)"},
"4": {"name": "Mark", "profile": "lily",
"text": "'I suppose this one would be the best one to start.'"},
"5": {"name": "Lily", "profile": "lily",
"text": "'Wow, cool! Do you want me to only read it while we're in the shop?'"},
"6": {"name": "Lily", "profile": "lily",
"text": "'Or would you be willing to lend it out to me to take home?'"},
"7": {"name": "Mark", "profile": "lily",
"text": "'I mean, I doubt it's interesting enough that you'd want to take it home...'"},
"8": {"name": "Lily", "profile": "lily",
...
"11": {"name": "Lily", "profile": "lily",
"text": "'Thanks Mark! I know it must mean a lot for you to trust me with this!'"},
"12": {"name": "Mark", "profile": "lily",
...
"text": "(Inside are a set of sandwiches, home-made by the look of it. I quickly take one and bite into it.)"},
"15": {"name": "Mark", "profile": "lily",
"text": "(Immediately, I am amazed by how good it is.)"},
"16": {"name": "Lily", "profile": "lily",
...
"text": "'Eh he he, you caught me. I packaged it all separately this morning then put it together right before giving it to you.'"},
"19": {"name": "Mark", "profile": "lily",
"text": "'This bread and meat isn't like anything I've had before either. In a good way, of course. It tastes so... fresh...'"},
"20": {"name": "Lily", "profile": "lily",
"text": "'Eh he he, thanks. I actually baked the bread myself from scratch. The meat I cooked last night too.'"},
...
"27": {"name": "Lily", "profile": "lily",
"text": "'But after I left home for college, cooking just for myself always somehow felt... wrong.'"},
"28": {"name": "Lily", "profile": "lily",
...
"dialogue": {
"0": {"name": "Mark", "profile": "",
"text": "(I delay for a while, but eventually start to feel guilty over all the lunch boxes and indeed plan a dinner with Lily.)"},
"1": {"name": "Mark", "profile": "",
"text": "(Cleaning took longer than expected, partly from tring to make all the sticky note labels as inconspicuous as possible.)"},
"2": {"name": "Mark", "profile": "",
"text": "(I briefly considered taking them down entirely, but I'd never be able to get them all in the right place afterward.)"},
"3": {"name": "Mark", "profile": "",
"text": "(Thankfully, Lily seemed not to notice.)"},
"4": {"name": "Mark", "profile": "",
"text": "(Dinner was not anything fancy.)"},
"5": {"name": "Mark", "profile": "",
...
"9": {"name": "Mark", "profile": "",
"text": "(Lily takes her leave with promises that she'll make an extra-special lunch tomorrow to pay me back for tonight.)"},
"10": {"name": "Mark", "profile": "",
"text": "(I don't bother trying to argue that the dinner was to pay her back for her lunches in the first place.)"},
},
"background": "cg1",
}
var scene_14 := {
...
"1": {"name": "Mark", "profile": "lily",
"text": "'More specifically, I have achromatopsia, the most severe type. I can't see anything but gray.'"},
"2": {"name": "Lily", "profile": "lily",
"text": "'Oh.'"},
"3": {"name": "Mark", "profile": "lily",
"text": "'I could see color before then, and the onset was gradual.'"},
"4": {"name": "Mark", "profile": "lily",
"text": "'When I was first diagnosed, the doctors said it might be transient and reversible,'"},
"5": {"name": "Mark", "profile": "lily",
"text": "'because I had no obvious injuries. So they suggested some exercises to try to restore my color vision.'"},
"6": {"name": "Mark", "profile": "lily",
"text": "'As part of that, I wrote notes on what color everything was, before it all went completely away.'"},
"7": {"name": "Mark", "profile": "lily",
...
"1": {"name": "Mark", "profile": "lily",
"text": "(special sandwiches which I'd previously admitted are my favorite after some of her light interrogation.)"},
...
"10": {"name": "Lily", "profile": "lily",
"text": "'That day, I was actually considering not turning it in and declining this job.'"},
"11": {"name": "Lily", "profile": "lily",
