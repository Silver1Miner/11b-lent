...
var scene_15 := {
"0": {"name": "Mark", "profile": "",
"text": "Lily does indeed make a special lunch the next day, a special batch of sandwiches which I've admited are my favorite after some grilling."},

"1": {"name": "Lily", "profile": "",
"text": "'Thanks for opening up to me. I feel like I should open up a little too, so it'd be fair.'"},
"2": {"name": "Mark", "profile": "",
...
var scene_16 := {
"0": {"name": "Mark", "profile": "",
"text": "It's obvious what you should do."},
"1": {"name": "Mark", "profile": "",
